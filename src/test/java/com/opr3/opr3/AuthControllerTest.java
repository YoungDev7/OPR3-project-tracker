...
public class AuthControllerTest {
    ...
    static Stream<Object[]> accessTokenTestCases() {
        ...
        return Stream.of(
                ...
                new Object[] { (Function<User, String>) mockJwtService::generateExpiredToken, HttpStatus.UNAUTHORIZED,
                ...
                new Object[] { (Function<User, String>) mockJwtService::generateMalformedToken, HttpStatus.UNAUTHORIZED,
